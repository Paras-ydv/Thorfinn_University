    ...
    <div className="bg-dark-900 pt-16">
      ...
      <section className="relative section-padding overflow-hidden">
        ...
        <div className="container-max relative z-10">
          <Link href="/departments" className="inline-flex items-center gap-2 text-gray-400 hover:text-white mb-8 transition-colors">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <span className="text-sm font-bold text-gray-500 uppercase tracking-wider">{dept.shortName}</span>
            <h1 className="text-4xl sm:text-5xl font-bold text-white mt-2 mb-4">{dept.name}</h1>
            <p className="text-xl text-gray-300 max-w-2xl leading-relaxed">{dept.description}</p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container-max px-4 sm:px-6 lg:px-8 pb-24 grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="glass rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Programs Offered</h2>
          ...
          {/* Labs */}
          <div className="glass rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Research Labs</h2>
            <div className="grid sm:grid-cols-2 gap-3">
              {dept.labs.map((lab) => (
              ...
              {FACULTY_SAMPLES.map((f) => (
                <div key={f.name} className="flex items-center gap-4 glass rounded-xl p-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">{f.specialization}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="space-y-6">
          <div className="glass rounded-2xl p-8 sticky top-24">
            <h3 className="text-lg font-bold text-white mb-6">Head of Department</h3>
            <div className="text-center">
              ...
              <h4 className="font-bold text-white text-lg">{dept.hod}</h4>
