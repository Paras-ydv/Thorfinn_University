...
const DEPARTMENTS: Record<string, {
  ...
  "computer-science": {
    ...
    facultyList: [
      ...
      { name: "Dr. Deepak Nair",           specialization: "Database Systems",    designation: "Professor" },
      { name: "Dr. Kavitha Subramaniam",   specialization: "NLP",                 designation: "Associate Professor" },
      { name: "Dr. Siddharth Rao",         specialization: "Cloud Computing",     designation: "Assistant Professor" },
      { name: "Dr. Nalini Krishnamurthy",  specialization: "Software Engineering",designation: "Associate Professor" },
    ],
    videoKey: "cse",
  },
  "electronics": {
    ...
    facultyList: [
      ...
      { name: "Dr. Harish Chandran",     specialization: "5G & Wireless",        designation: "Professor" },
      { name: "Dr. Preethi Balakrishnan",specialization: "Power Electronics",    designation: "Associate Professor" },
      { name: "Dr. Ganesh Iyer",         specialization: "Photonics",            designation: "Assistant Professor" },
    ],
    videoKey: "ece",
  },
  "mechanical": {
    ...
    facultyList: [
      ...
      { name: "Dr. Suresh Venkataraman", specialization: "CFD",                 designation: "Professor" },
      { name: "Dr. Rekha Pillai",        specialization: "Additive Manufacturing",designation: "Associate Professor" },
      { name: "Dr. Vivek Srinivasan",    specialization: "HVAC & Energy",       designation: "Assistant Professor" },
    ],
    videoKey: "mech",
  },
  "civil": {
    ...
    facultyList: [
      ...
      { name: "Dr. Balaji Krishnaswamy", specialization: "Water Resources",        designation: "Professor" },
      { name: "Dr. Meghna Desai",        specialization: "Urban Planning & GIS",   designation: "Associate Professor" },
    ],
    videoKey: "civil",
  },
  "mba": {
    ...
    facultyList: [
      ...
      { name: "Dr. Ashwin Menon",    specialization: "Entrepreneurship",      designation: "Professor" },
      { name: "Dr. Lakshmi Venkatesh",specialization: "HR Management",        designation: "Associate Professor" },
      { name: "Dr. Rohit Bhatia",    specialization: "International Business",designation: "Assistant Professor" },
    ],
    videoKey: "mba",
  },
  "csbs": {
    ...
    facultyList: [
      ...
      { name: "Dr. Kavitha Subramaniam", specialization: "NLP & AI",              designation: "Associate Professor" },
      { name: "Dr. Nalini Krishnamurthy",specialization: "Software Engineering",  designation: "Associate Professor" },
    ],
    videoKey: "csbs",
  },
  "ml": {
    ...
    facultyList: [
      ...
      { name: "Dr. Kavitha Subramaniam", specialization: "NLP & LLMs",       designation: "Associate Professor" },
      { name: "Dr. Siddharth Rao",       specialization: "MLOps & Cloud",    designation: "Assistant Professor" },
    ],
    videoKey: "ml",
  },
  "mtech-ai-ml": {
  ...
  "vlsi": {
    ...
    facultyList: [
      ...
      { name: "Dr. Harish Chandran",     specialization: "5G & RF",        designation: "Professor" },
      { name: "Dr. Ganesh Iyer",         specialization: "Photonics",      designation: "Assistant Professor" },
    ],
    videoKey: "vlsi",
  },
