      ...
      <section className="section-padding container-max">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {[
            ...
            <motion.button key={link} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="glass rounded-xl p-4 text-sm text-slate-700 hover:text-slate-900 hover:bg-slate-200 transition-all text-center">
              {link}
            </motion.button>
          ))}
        </div>
